...
4. Определение модели ФН, ККТ и наименования ОФД по заводским номерам и ИНН соответственно;

5. Сброс МГМ (для технических целей);

6. *Закрытие смены и архива ФН текущей датой или датой последнего документа ФН;*

7. Чтение выгрузок архивов ФН в формате .fnc, создаваемом программами FNArc и FNTransfer **в полном соответствии с пунктами
45 – 48 Приложения 2 к приказу ФНС России «Форматы фискальных документов, обязательные к использованию»**.
